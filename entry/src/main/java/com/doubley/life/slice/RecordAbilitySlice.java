...
import com.doubley.life.RecordAbility;
...
public class RecordAbilitySlice extends AbilitySlice {

        private static final String TAG = RecordAbility.class.getSimpleName();
        ...
        private void initMediaRecorder() {          //录像路径存储
        ...
        private void stopRecord() {       //停止录像且存储路径
            synchronized (lock) {
                try {
            ...
            new ToastDialog(this).setText("take video succeed ").show();
            DataUtil.addSource(new Resource(videoPath));
        ...
        private class SurfaceCallBack implements SurfaceOps.Callback {
            ...
            public void surfaceCreated(SurfaceOps callbackSurfaceOps) {
                ...
                eventHandler.postTask(RecordAbilitySlice.this::openCamera, 200);
            }
